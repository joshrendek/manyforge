...
- [ ] **Step 2: Write the failing test** (`internal/connectors/zendesk/client_test.go`)
...
- [ ] **Step 3: Run the test to verify it fails to COMPILE/FAIL**
...
- [ ] **Step 4: Write `internal/connectors/zendesk/client.go`** (skeleton + FetchIssue)
...
- [ ] **Step 5: Write `internal/connectors/zendesk/factory.go`**
...
- [ ] **Step 6: Register the factory in `cmd/manyforge/main.go`**
