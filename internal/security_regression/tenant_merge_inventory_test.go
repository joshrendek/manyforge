...
var tenantMergeTableInventory = map[string]string{
	...
	"mailing_brand":                     "drain_fence_then_rewrite",
...
var tenantMergeTenantFKInventory = map[string]bool{
	...
	"mailing_brand.mailing_brand_business_fk":                                                        true,
...
var tenantMergeImmutabilityInventory = map[string]string{
	...
	"mailing_brand.mailing_brand_troot_immutable":                                             "support_tenant_root_immutable",
