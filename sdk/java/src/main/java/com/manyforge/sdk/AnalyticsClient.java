...
public final class AnalyticsClient extends Resources.Analytics implements AutoCloseable {
    private final NativeTransport http;
    private AnalyticsClient(Builder builder) {
        this(new NativeTransport(builder.baseUrl, builder.timeout, builder.httpClient, null, null, null,
            NativeTransport.required(builder.publishableKey, "publishableKey"), null, null, NativeTransport.required(builder.sourceOrigin, "sourceOrigin")), builder.publishableKey);
    }
    private AnalyticsClient(NativeTransport transport, String key) { super(transport, key); http = transport; }
    ...
    public static final class Builder {
        ...
        public Builder sourceOrigin(String value) { sourceOrigin = NativeTransport.required(value, "sourceOrigin"); return this; }
        ...
        public AnalyticsClient build() { return new AnalyticsClient(this); }
    }
}
