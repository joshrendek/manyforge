...
public final class MailingClient extends Resources.Mailing implements AutoCloseable {
    private final NativeTransport http;
    private MailingClient(Builder builder) {
    ...
    private MailingClient(NativeTransport transport, String key) { super(transport, key); http = transport; }
    ...
    public static final class Builder {
        ...
        public MailingClient build() { return new MailingClient(this); }
    }
}
