...
public final class TelemetryClient extends Resources.Telemetry implements AutoCloseable {
    ...
    private TelemetryClient(NativeTransport transport, String key) { super(transport, key); http = transport; }
    ...
    public static final class Builder {
        ...
        public TelemetryClient build() { return new TelemetryClient(this); }
    }
}
