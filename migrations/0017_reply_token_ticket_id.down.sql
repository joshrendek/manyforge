-- Revert manyforge-btv: drop the p_ticket_id variant and restore the 0014
-- 17-arg ingest_inbound_message verbatim (id supplied by the column DEFAULT).

DROP FUNCTION IF EXISTS ingest_inbound_message(
    uuid, uuid, citext, citext, text, text, text, text, text[], text,
    text, jsonb, boolean, uuid, uuid, text, jsonb, text);
