...
describe('NAV_ITEMS', () => {
  it('includes product navigation in its stable order with testids', () => {
    ...
    expect(NAV_ITEMS.find((n) => n.route === '/mailing/lists')?.testid).toBe('nav-mailing');
    expect(NAV_ITEMS.find((n) => n.route === '/mailing/campaigns')?.testid).toBe(
      'nav-mailing-campaigns',
    );
    expect(NAV_ITEMS.find((n) => n.route === '/mailing/automations')?.testid).toBe(
      'nav-mailing-automations',
    );
    ...
    expect(NAV_ITEMS.find((n) => n.route === '/code-review/setup')?.testid).toBe(
      'nav-review-setup',
    );
