...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Mailing', route: '/mailing/lists', testid: 'nav-mailing' },
  { label: 'Campaigns', route: '/mailing/campaigns', testid: 'nav-mailing-campaigns' },
  { label: 'Automations', route: '/mailing/automations', testid: 'nav-mailing-automations' },
